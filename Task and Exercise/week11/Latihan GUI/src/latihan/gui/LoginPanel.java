 ...
 */
 ...
 initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        // databaseConnection.getInstance().login(jTextField1.getText(), jTextField2.getText());
        ResultSet resultSet;
        try {
            resultSet = databaseConnection.getInstance().getUser(jTextField1.getText(), jTextField2.getText());
