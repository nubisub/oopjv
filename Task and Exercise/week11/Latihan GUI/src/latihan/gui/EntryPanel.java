...
public class EntryPanel extends javax.swing.JPanel {
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addComponent(namaTextField, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 182, javax.swing.GroupLayout.PREFERRED_SIZE)))))
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        Object[] rowData = new Object[mahasiswaTable.getColumnCount()];
        int row = mahasiswaTable.getSelectedRow();
        System.out.println(row);
        // row nim
        rowData[0] = mahasiswaTable.getValueAt(row, 0);
        System.out.println(rowData[0]);
        try {
            databaseConnection.getInstance().deleteMahasiswa(rowData[0].toString());
            loadTableData();
        } catch (SQLException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
...
//        Mainframe.update();
        ...
        MainFrame.update(rowData[0].toString());
...
// refresh tabel
 ...
 try {
    ResultSet result = databaseConnection.getInstance().getAllMahasiswa();
    while(result.next()){
        String nim = result.getString("nim");
        String nama = result.getString("nama");
        String jenisKelamin = result.getString("sex");
        int umur = result.getInt("umur");
        String alamat = result.getString("alamat");
        String provinsi = result.getString("provinsi");
        // dtm.addRow(new Object[]{nim, nama, jenisKelamin, umur, alamat, provinsi, hobi});
        dtm.addRow(new Object[]{nim, nama, jenisKelamin, umur});
    }
} catch (SQLException e) {
    // TODO Auto-generated catch block
    e.printStackTrace();
 ...
 //isi tabel
//  for(Mahasiswa mhs:databaseConnection.getInstance().getAllMahasiswa()){
