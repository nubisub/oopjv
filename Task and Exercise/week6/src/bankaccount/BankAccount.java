    ...
    */
    public void tampilListRekeningBank() {
        ...
        for (int i = 0; i < akunBank.size(); i++) {
            System.out.println((i+1) + ". [" + akunBank.get(i).getBank() 
            + "] [" + akunBank.get(i).getNoRek() + "] [" + akunBank.get(i).getSaldo() + "]");
        }
        System.out.println("================================================ ");
    }
    /**
    ...
    public double rekapSaldoRekening() {
        ...
        System.out.println("Total Saldo Semua Rekening "
        +this.nama+ " : Rp." + rekapSaldo);
        return rekapSaldo;
    }
}
...
class Bank {
    ...
    */     
    public String generateNoRek() {
        ...
        for (int i = 0; i < 6; i++) {
            nomorRekening += rand.nextInt(10);
        }
        return kodeBank+nomorRekening;
    }
}
